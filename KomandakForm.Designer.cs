namespace _2taldea
{
    partial class KomandakForm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(KomandakForm));
            labelIzena = new Label();
            pictureBoxLogo = new PictureBox();
            btnAtzera = new Button();
            labelMahaiak = new Label(); // Instanciamos el control
            ...
            labelMahaiak.Size = new Size(196, 45);
            ...
            Controls.Add(labelMahaiak); // Añadimos el nuevo control
